...
namespace Database
{
	...
	public class CombatUnitConfig : ScriptableObject
	{
		...
		[field: SerializeField] public float AgentMoveSpeed { get; private set; } = 5;
		[field: SerializeField] public float AgentAcceleration { get; private set; } = 10;
		[field: SerializeField] public float AgentAngularSpeed { get; private set; } = 360;
